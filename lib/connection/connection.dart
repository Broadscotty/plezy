...
class DebridConnection extends Connection {
  ...
  /// Optional for AIOStreams-style addons that embed the key in their stream
  /// URLs; empty means the client extracts it lazily from the redirect chain.
  ...
  @override
  String get displayLabel => 'Stremio';
