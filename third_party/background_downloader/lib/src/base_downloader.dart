...
abstract base class BaseDownloader {
  ...
  /// Remove the task with [taskId] from the platform schedule without a
  /// status update and without deleting its temp file. Used by recovery to
  /// clear a zombie worker from a killed session without destroying the
  /// partial it was writing.
  Future<void> killTaskWithId(String taskId);
